...
data class ExchangeRate(@Id @Convert(converter = UUIDConverter::class) @Column(length = 36) val id: UUID = UUID.randomUUID(), var currency_from: UUID, var currency_to: UUID, var symbol: String, var rate: Double) {
